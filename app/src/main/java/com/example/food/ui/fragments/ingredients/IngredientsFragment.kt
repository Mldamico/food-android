...
import com.example.food.adapters.IngredientsAdaptor
import com.example.food.models.Result
import com.example.food.util.Constants.Companion.RECIPE_RESULT
import kotlinx.android.synthetic.main.fragment_ingredients.view.*


class IngredientsFragment : Fragment() {
    private val mAdapter: IngredientsAdaptor by lazy { IngredientsAdaptor()}
